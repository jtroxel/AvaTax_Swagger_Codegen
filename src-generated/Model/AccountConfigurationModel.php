...
/**
 * AccountConfigurationModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountConfigurationModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountConfigurationModel';
     ...
     * Sets account_id
     *
     * @param int $account_id The unique ID number of the account to which this setting applies
     *
     * @return $this
     */
    ...
    public function setCategory($category)
    {
        if ((mb_strlen($category) > 25)) {
            throw new \InvalidArgumentException('invalid length for $category when calling AccountConfigurationModel., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($category) < 0)) {
            throw new \InvalidArgumentException('invalid length for $category when calling AccountConfigurationModel., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountConfigurationModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountConfigurationModel., must be bigger than or equal to 0.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 200)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AccountConfigurationModel., must be smaller than or equal to 200.');
        }
        if (!is_null($value) && (mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AccountConfigurationModel., must be bigger than or equal to 0.');
        }
