...
/**
 * DeleteErrorTransactionResponseModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteErrorTransactionResponseModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteErrorTransactionResponseModel';
     ...
     * Sets result
     *
     * @param string $result Result of the deletion
     *
     * @return $this
     */
    ...
    public function setDocumentCode($document_code)
    {
        if ((mb_strlen($document_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $document_code when calling DeleteErrorTransactionResponseModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($document_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $document_code when calling DeleteErrorTransactionResponseModel., must be bigger than or equal to 0.');
        }
