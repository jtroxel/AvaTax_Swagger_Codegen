...
/**
 * AccountLicenseKeyModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountLicenseKeyModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountLicenseKeyModel';
     ...
     * Sets name
     *
     * @param string $name The unique name for license key per account
     *
     * @return $this
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountLicenseKeyModel., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountLicenseKeyModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets account_id
     *
     * @param int $account_id AccountId for required license key
     *
     * @return $this
     */
     ...
     *
     * @param int $created_user_id The user id for the user who created this record.
     *
     * @return $this
     */
     ...
     *
     * @param int $modified_user_id The user id of user who last modified this record.
     *
     * @return $this
     */
