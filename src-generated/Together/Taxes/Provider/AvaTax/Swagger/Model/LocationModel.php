...
class LocationModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'settings' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationSettingModel[]',
        'parameters' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[]'
    ];
     ...
     * Gets settings
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationSettingModel[]
     */
     ...
     * Sets settings
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationSettingModel[] $settings Extra information required by certain jurisdictions for filing.  For a list of settings recognized by Avalara, query the endpoint \"/api/v2/definitions/locationquestions\".  To determine the list of settings required for this location, query the endpoint \"/api/v2/companies/(id)/locations/(id)/validate\".
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[] $parameters List of location parameters.
     *
     * @return $this
     */
