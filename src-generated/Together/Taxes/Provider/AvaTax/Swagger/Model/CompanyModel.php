...
class CompanyModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'contacts' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ContactModel[]',
        'items' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ItemModel[]',
        'locations' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[]',
        'nexus' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\NexusModel[]',
        'settings' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\SettingModel[]',
        'tax_codes' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\TaxCodeModel[]',
        'tax_rules' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\TaxRuleModel[]',
        'upcs' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[]',
        'non_reporting_child_companies' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\CompanyModel[]',
        'exempt_certs' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\EcmsModel[]',
        'moss_id' => 'string',
        'moss_country' => 'string',
        'parameters' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\CompanyParameterDetailModel[]'
    ];
     ...
     * Sets items
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\ItemModel[] $items Optional: A list of items defined for this company.  To fetch this list, add the query string `?$include=Items` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     * Sets locations
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[] $locations Optional: A list of locations defined for this company.  To fetch this list, add the query string `?$include=Locations` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     * Sets nexus
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\NexusModel[] $nexus Optional: A list of nexus defined for this company.  To fetch this list, add the query string `?$include=Nexus` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     * Sets settings
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\SettingModel[] $settings Optional: A list of settings defined for this company.  To fetch this list, add the query string `?$include=Settings` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     * Sets tax_codes
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\TaxCodeModel[] $tax_codes Optional: A list of tax codes defined for this company.  To fetch this list, add the query string `?$include=TaxCodes` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     * Sets upcs
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[] $upcs Optional: A list of UPCs defined for this company.  To fetch this list, add the query string `?$include=UPCs` to your URL.                When calling `CreateCompany`, you may provide a list of objects in this element and they will be created alongside the company.  The `UpdateCompany` API does not permit updating nested objects.
     *
     * @return $this
     */
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\CompanyModel[] $non_reporting_child_companies Optional: A list of non reporting child companies associated with this company.  To fetch this list, add the query string `?$include=NonReportingChildren` to your URL.
     *
     * @return $this
     */
     ...
     * Gets exempt_certs
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\EcmsModel[]
     */
     ...
     * Sets exempt_certs
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\EcmsModel[] $exempt_certs DEPRECATED - Date: 9/15/2017, Version: 17.10, Message: Please use the `ListCertificates` API.
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\CompanyParameterDetailModel[] $parameters The parameters of a company
     *
     * @return $this
     */
