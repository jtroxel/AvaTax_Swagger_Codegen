...
class CurrencyModel implements ModelInterface, ArrayAccess
{
     ...
     * Sets code
     *
     * @param string $code The ISO 4217 currency code for this currency.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description A friendly human-readable name representing this currency.
     *
     * @return $this
     */
     ...
     * Sets decimal_digits
     *
     * @param int $decimal_digits The number of decimal digits to use when formatting a currency value for display.
     *
     * @return $this
     */
