 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateMultiDocumentModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateMultiDocumentModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['allow_adjust'] = isset($data['allow_adjust']) ? $data['allow_adjust'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['code']) && (mb_strlen($this->container['code']) > 45)) {
     ...
     * Sets code
     *
     * @param string $code The transaction code of the MultiDocument transaction.                All individual transactions within this MultiDocument object will have this code as a prefix.                If you leave the `code` field blank, a GUID will be assigned.
     *
     * @return $this
     */
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 45)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateMultiDocumentModel., must be smaller than or equal to 45.');
        }
        if (!is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
     ...
     * Gets lines
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\MultiDocumentLineItemModel[]
     */
     ...
     * @return bool
     */
    public function getAllowAdjust()
    {
        return $this->container['allow_adjust'];
    }

    /**
     * Sets allow_adjust
     *
     * @param bool $allow_adjust Set this value to true to allow this API call to adjust the MultiDocument model if one already exists.                If you omit this field, or if the value is `null`, you will receive an error if you try to create two MultiDocument  objects with the same `code`.
     *
     * @return $this
     */
    public function setAllowAdjust($allow_adjust)
    {
        $this->container['allow_adjust'] = $allow_adjust;
    ...
    public function setCompanyCode($company_code)
    {
        if (!is_null($company_code) && (mb_strlen($company_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if (!is_null($company_code) && (mb_strlen($company_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setSalespersonCode($salesperson_code)
    {
        if (!is_null($salesperson_code) && (mb_strlen($salesperson_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $salesperson_code when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($salesperson_code) && (mb_strlen($salesperson_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $salesperson_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCustomerCode($customer_code)
    {
        if ((mb_strlen($customer_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($customer_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCustomerUsageType($customer_usage_type)
    {
        if (!is_null($customer_usage_type) && (mb_strlen($customer_usage_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $customer_usage_type when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($customer_usage_type) && (mb_strlen($customer_usage_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_usage_type when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setEntityUseCode($entity_use_code)
    {
        if (!is_null($entity_use_code) && (mb_strlen($entity_use_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $entity_use_code when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($entity_use_code) && (mb_strlen($entity_use_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $entity_use_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseOrderNo($purchase_order_no)
    {
        if (!is_null($purchase_order_no) && (mb_strlen($purchase_order_no) > 50)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_no when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if (!is_null($purchase_order_no) && (mb_strlen($purchase_order_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_no when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setExemptionNo($exemption_no)
    {
        if (!is_null($exemption_no) && (mb_strlen($exemption_no) > 25)) {
            throw new \InvalidArgumentException('invalid length for $exemption_no when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($exemption_no) && (mb_strlen($exemption_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $exemption_no when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setReferenceCode($reference_code)
    {
        if (!is_null($reference_code) && (mb_strlen($reference_code) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $reference_code when calling CreateMultiDocumentModel., must be smaller than or equal to 1024.');
        }
        if (!is_null($reference_code) && (mb_strlen($reference_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setReportingLocationCode($reporting_location_code)
    {
        if (!is_null($reporting_location_code) && (mb_strlen($reporting_location_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $reporting_location_code when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if (!is_null($reporting_location_code) && (mb_strlen($reporting_location_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reporting_location_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setBatchCode($batch_code)
    {
        if (!is_null($batch_code) && (mb_strlen($batch_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $batch_code when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($batch_code) && (mb_strlen($batch_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreateMultiDocumentModel., must be smaller than or equal to 3.');
        }
        if (!is_null($currency_code) && (mb_strlen($currency_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPosLaneCode($pos_lane_code)
    {
        if (!is_null($pos_lane_code) && (mb_strlen($pos_lane_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $pos_lane_code when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if (!is_null($pos_lane_code) && (mb_strlen($pos_lane_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pos_lane_code when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setBusinessIdentificationNo($business_identification_no)
    {
        if (!is_null($business_identification_no) && (mb_strlen($business_identification_no) > 25)) {
            throw new \InvalidArgumentException('invalid length for $business_identification_no when calling CreateMultiDocumentModel., must be smaller than or equal to 25.');
        }
        if (!is_null($business_identification_no) && (mb_strlen($business_identification_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $business_identification_no when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateMultiDocumentModel., must be smaller than or equal to 2048.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateMultiDocumentModel., must be smaller than or equal to 50.');
        }
        if (!is_null($email) && (mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateMultiDocumentModel., must be bigger than or equal to 0.');
        }
