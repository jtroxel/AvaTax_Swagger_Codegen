...
class AuditMultiDocumentModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'reconstructed' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ReconstructedMultiDocumentModel',
        'code' => 'string',
        'type' => 'string',
     ...
     * Gets reconstructed
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\ReconstructedMultiDocumentModel
     */
     ...
     * Sets reconstructed
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\ReconstructedMultiDocumentModel $reconstructed Reconstructed API request/response pair that can be used to adjust or re-create this MultiDocument transaction.
     *
     * @return $this
     */
