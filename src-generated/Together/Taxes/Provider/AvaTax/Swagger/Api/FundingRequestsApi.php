...
class FundingRequestsApi
{
    ...
    {
        list($response) = $this->activateFundingRequestWithHttpInfo($id, $x_avalara_client);
        return $response;
    }

    /**
     * Operation activateFundingRequestWithHttpInfo
     *
     * Request the javascript for a funding setup widget
     *
     * @param  int $id The unique ID number of this funding request (required)
    ...
    /**
     * Operation activateFundingRequestAsync
     *
     * Request the javascript for a funding setup widget
     *
     * @param  int $id The unique ID number of this funding request (required)
     ...
     */
    public function activateFundingRequestAsync($id, $x_avalara_client = 'Swagger UI; 20.9.0; Custom; 1.0')
    {
        return $this->activateFundingRequestAsyncWithHttpInfo($id, $x_avalara_client)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activateFundingRequestAsyncWithHttpInfo
     *
     * Request the javascript for a funding setup widget
     *
     * @param  int $id The unique ID number of this funding request (required)
    ...
    /**
     * Create request for operation 'activateFundingRequest'
     *
     * @param  int $id The unique ID number of this funding request (required)
     * @param  string $x_avalara_client Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . (optional, default to Swagger UI; 20.9.0; Custom; 1.0)
     *
     ...
     */
    protected function activateFundingRequestRequest($id, $x_avalara_client = 'Swagger UI; 20.9.0; Custom; 1.0')
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling activateFundingRequest'
            );
        }

        $resourcePath = '/api/v2/fundingrequests/{id}/widget';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->fundingRequestStatusWithHttpInfo($id, $x_avalara_client);
        return $response;
    }

    /**
     * Operation fundingRequestStatusWithHttpInfo
     *
     * Retrieve status about a funding setup request
     *
     * @param  int $id The unique ID number of this funding request (required)
    ...
    /**
     * Operation fundingRequestStatusAsync
     *
     * Retrieve status about a funding setup request
     *
     * @param  int $id The unique ID number of this funding request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fundingRequestStatusAsync($id, $x_avalara_client = 'Swagger UI; 20.9.0; Custom; 1.0')
    {
        return $this->fundingRequestStatusAsyncWithHttpInfo($id, $x_avalara_client)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fundingRequestStatusAsyncWithHttpInfo
     *
     * Retrieve status about a funding setup request
     *
     * @param  int $id The unique ID number of this funding request (required)
    ...
    /**
     * Create request for operation 'fundingRequestStatus'
     *
     * @param  int $id The unique ID number of this funding request (required)
     * @param  string $x_avalara_client Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . (optional, default to Swagger UI; 20.9.0; Custom; 1.0)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function fundingRequestStatusRequest($id, $x_avalara_client = 'Swagger UI; 20.9.0; Custom; 1.0')
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling fundingRequestStatus'
            );
        }

        $resourcePath = '/api/v2/fundingrequests/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
