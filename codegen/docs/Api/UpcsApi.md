# Together\Taxes\Provider\AvaTax\Swagger\UpcsApi
...
# **createUPCs**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[] createUPCs($company_id, $x_avalara_client, $body)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\UpcsApi(
...
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[] | The UPC you wish to create.
 ...
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[]**](../Model/UPCModel.md)| The UPC you wish to create. | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel[]**](../Model/UPCModel.md)
...
# **deleteUPC**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteUPC($company_id, $id, $x_avalara_client)
...
# **getUPC**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel getUPC($company_id, $id, $x_avalara_client)
...
# **listUPCsByCompany**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultUPCModel listUPCsByCompany($company_id, $filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultUPCModel**](../Model/FetchResultUPCModel.md)
...
# **queryUPCs**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultUPCModel queryUPCs($filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
# **updateUPC**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel updateUPC($company_id, $id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel | The UPC you wish to update.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\UPCModel**](../Model/UPCModel.md)| The UPC you wish to update. | [optional]
