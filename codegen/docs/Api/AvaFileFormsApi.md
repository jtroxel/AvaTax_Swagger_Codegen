# Together\Taxes\Provider\AvaTax\Swagger\AvaFileFormsApi
...
# **createAvaFileForms**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel[] createAvaFileForms($x_avalara_client, $body)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\AvaFileFormsApi(
...
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel[] | The AvaFileForm you wish to create.
 ...
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel[]**](../Model/AvaFileFormModel.md)| The AvaFileForm you wish to create. | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel[]**](../Model/AvaFileFormModel.md)
...
# **deleteAvaFileForm**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteAvaFileForm($id, $x_avalara_client)
...
# **getAvaFileForm**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel getAvaFileForm($id, $x_avalara_client)
...
# **queryAvaFileForms**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultAvaFileFormModel queryAvaFileForms($filter, $top, $skip, $order_by, $x_avalara_client)
...
# **updateAvaFileForm**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel updateAvaFileForm($id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel | The AvaFileForm model you wish to update.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\AvaFileFormModel**](../Model/AvaFileFormModel.md)| The AvaFileForm model you wish to update. | [optional]
