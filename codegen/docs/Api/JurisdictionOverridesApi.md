# Together\Taxes\Provider\AvaTax\Swagger\JurisdictionOverridesApi
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel[] createJurisdictionOverrides($account_id, $x_avalara_client, $body)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\JurisdictionOverridesApi(
...
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel[] | The jurisdiction override objects to create
 ...
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel[]**](../Model/JurisdictionOverrideModel.md)| The jurisdiction override objects to create | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel[]**](../Model/JurisdictionOverrideModel.md)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteJurisdictionOverride($account_id, $id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel getJurisdictionOverride($account_id, $id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultJurisdictionOverrideModel listJurisdictionOverridesByAccount($account_id, $filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultJurisdictionOverrideModel queryJurisdictionOverrides($filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel updateJurisdictionOverride($account_id, $id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel | The jurisdictionoverride object you wish to update.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\JurisdictionOverrideModel**](../Model/JurisdictionOverrideModel.md)| The jurisdictionoverride object you wish to update. | [optional]
