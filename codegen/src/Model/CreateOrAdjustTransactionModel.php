...
class CreateOrAdjustTransactionModel implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\CreateTransactionModel $create_transaction_model The create transaction model to be created or updated.                If the transaction does not exist, create transaction.  If the transaction exists, adjust the existing transaction.
     *
     * @return $this
     */
