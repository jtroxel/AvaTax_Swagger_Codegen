...
class TransactionLineModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'tax_included' => 'bool',
        'details' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineDetailModel[]',
        'non_passthrough_details' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineDetailModel[]',
        'line_location_types' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineLocationTypeModel[]',
     ...
     * Gets details
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineDetailModel[]
     */
     ...
     * Sets details
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineDetailModel[] $details Optional: A list of tax details for this line item.                Tax details represent taxes being charged by various tax authorities. Taxes that appear in the `details` collection are intended to be  displayed to the customer and charged as a 'tax' on the invoice.                To fetch this list, add the query string `?$include=Details` to your URL.
     *
     * @return $this
     */
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineDetailModel[] $non_passthrough_details Optional: A list of non-passthrough tax details for this line item.                Tax details represent taxes being charged by various tax authorities. Taxes that appear in the `nonPassthroughDetails` collection are  taxes that must be paid directly by the company and not shown to the customer.
     *
     * @return $this
     */
     ...
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineLocationTypeModel[]
     */
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineLocationTypeModel[] $line_location_types Optional: A list of location types for this line item.  To fetch this list, add the query string \"?$include=LineLocationTypes\" to your URL.
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\TransactionLineParameterModel[] $parameters Contains a list of extra parameters that were set when the transaction was created.
     *
     * @return $this
     */
