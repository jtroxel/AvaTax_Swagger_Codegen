...
class CertificateModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'validated_exemption_reason' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ExemptionReasonModel',
        'exemption_reason' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ExemptionReasonModel',
        'status' => 'string',
        'created_date' => '\DateTime',
        'modified_date' => '\DateTime',
        'page_count' => 'int',
        'customers' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\CustomerModel[]',
        'po_numbers' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\PoNumberModel[]',
        'exposure_zone' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\ExposureZoneModel',
        'attributes' => '\Together\Taxes\Provider\AvaTax\Swagger\Model\CertificateAttributeModel[]',
        'ecms_id' => 'int',
        'ecms_status' => 'string',
        'pdf' => 'string',
        'pages' => 'string[]'
     ...
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\ExemptionReasonModel
     */
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\ExemptionReasonModel $validated_exemption_reason The exemption reason that CertCapture audit/internal logic identifies for created certificate.
     *
     * @return $this
     */
     ...
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\ExemptionReasonModel $exemption_reason The exemption reason associated with this certificate.  For example, the reason code for exemption  for purposes of resale is `RESALE`.                For a list of exemption reasons, call `ListCertificateExemptReasons`.
     *
     * @return $this
     */
     ...
     * Sets customers
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\CustomerModel[] $customers A list of customers to which this certificate applies.  You can fetch this data by specifying  `$include=customers` when calling a certificate fetch API.
     *
     * @return $this
     */
     ...
     * Gets po_numbers
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\PoNumberModel[]
     */
     ...
     * Sets exposure_zone
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\ExposureZoneModel $exposure_zone The exposure zone where this certificate is valid.
     *
     * @return $this
     */
     ...
     * Gets attributes
     *
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\CertificateAttributeModel[]
     */
     ...
     * Sets attributes
     *
     * @param \Together\Taxes\Provider\AvaTax\Swagger\Model\CertificateAttributeModel[] $attributes A list of certificate attributes that apply to this certificate.                You can fetch this data by specifying `$include=attributes` when calling a certificate fetch API.
     *
     * @return $this
     */
