...
/**
 * MultiDocumentLineItemModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiDocumentLineItemModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiDocumentLineItemModel';
     ...
     * Sets company_code
     *
     * @param string $company_code Specify the code of the company for this line of transaction.                If you leave this value null, the `companyCode` at the root level will be used instead.
     *
     * @return $this
     */
     ...
     *
     * @param string $reporting_location_code Sets the sale location code (Outlet ID) for reporting this document to the tax authority.                If you leave this value `null`, the `reportingLocationCode` at the root level will be used instead.
     *
     * @return $this
     */
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling MultiDocumentLineItemModel., must be smaller than or equal to 50.');
        }
        if (!is_null($number) && (mb_strlen($number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $number when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        if (!is_null($tax_code) && (mb_strlen($tax_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling MultiDocumentLineItemModel., must be smaller than or equal to 25.');
        }
        if (!is_null($tax_code) && (mb_strlen($tax_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCustomerUsageType($customer_usage_type)
    {
        if (!is_null($customer_usage_type) && (mb_strlen($customer_usage_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $customer_usage_type when calling MultiDocumentLineItemModel., must be smaller than or equal to 25.');
        }
        if (!is_null($customer_usage_type) && (mb_strlen($customer_usage_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_usage_type when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setEntityUseCode($entity_use_code)
    {
        if (!is_null($entity_use_code) && (mb_strlen($entity_use_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $entity_use_code when calling MultiDocumentLineItemModel., must be smaller than or equal to 25.');
        }
        if (!is_null($entity_use_code) && (mb_strlen($entity_use_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $entity_use_code when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setItemCode($item_code)
    {
        if (!is_null($item_code) && (mb_strlen($item_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $item_code when calling MultiDocumentLineItemModel., must be smaller than or equal to 50.');
        }
        if (!is_null($item_code) && (mb_strlen($item_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $item_code when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setRevenueAccount($revenue_account)
    {
        if (!is_null($revenue_account) && (mb_strlen($revenue_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $revenue_account when calling MultiDocumentLineItemModel., must be smaller than or equal to 50.');
        }
        if (!is_null($revenue_account) && (mb_strlen($revenue_account) < 0)) {
            throw new \InvalidArgumentException('invalid length for $revenue_account when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setRef1($ref1)
    {
        if (!is_null($ref1) && (mb_strlen($ref1) > 250)) {
            throw new \InvalidArgumentException('invalid length for $ref1 when calling MultiDocumentLineItemModel., must be smaller than or equal to 250.');
        }
        if (!is_null($ref1) && (mb_strlen($ref1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ref1 when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setRef2($ref2)
    {
        if (!is_null($ref2) && (mb_strlen($ref2) > 250)) {
            throw new \InvalidArgumentException('invalid length for $ref2 when calling MultiDocumentLineItemModel., must be smaller than or equal to 250.');
        }
        if (!is_null($ref2) && (mb_strlen($ref2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ref2 when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling MultiDocumentLineItemModel., must be smaller than or equal to 2096.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setBusinessIdentificationNo($business_identification_no)
    {
        if (!is_null($business_identification_no) && (mb_strlen($business_identification_no) > 25)) {
            throw new \InvalidArgumentException('invalid length for $business_identification_no when calling MultiDocumentLineItemModel., must be smaller than or equal to 25.');
        }
        if (!is_null($business_identification_no) && (mb_strlen($business_identification_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $business_identification_no when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
    ...
    public function setHsCode($hs_code)
    {
        if (!is_null($hs_code) && (mb_strlen($hs_code) > 25)) {
            throw new \InvalidArgumentException('invalid length for $hs_code when calling MultiDocumentLineItemModel., must be smaller than or equal to 25.');
        }
        if (!is_null($hs_code) && (mb_strlen($hs_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $hs_code when calling MultiDocumentLineItemModel., must be bigger than or equal to 0.');
        }
