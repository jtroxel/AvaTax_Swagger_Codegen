...
class FreeApi
{
     ...
     *
     * @param  \Together\Taxes\Provider\AvaTax\Swagger\Model\FreeTrialRequestModel $body Required information to provision a free trial account. (optional)
     *
     ...
     * @throws \Together\Taxes\Provider\AvaTax\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\TaxRateModel
     */
     ...
     * @throws \Together\Taxes\Provider\AvaTax\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Together\Taxes\Provider\AvaTax\Swagger\Model\TaxRateModel, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Together\Taxes\Provider\AvaTax\Swagger\Model\TaxRateModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Together\Taxes\Provider\AvaTax\Swagger\Model\TaxRateModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
