...
class SubscriptionsApi
{
     ...
     * @throws \Together\Taxes\Provider\AvaTax\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultSubscriptionModel
     */
     ...
     * @throws \Together\Taxes\Provider\AvaTax\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultSubscriptionModel, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultSubscriptionModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultSubscriptionModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
