# Together\Taxes\Provider\AvaTax\Swagger\FirmClientLinkagesApi
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel approveFirmClientLinkage($id, $x_avalara_client)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\FirmClientLinkagesApi(
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel**](../Model/FirmClientLinkageOutputModel.md)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel createAndLinkNewFirmClientAccount($x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\NewFirmClientAccountRequestModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\NewFirmClientAccountRequestModel | Information about the account you wish to create.
...
------------- | ------------- | ------------- | -------------
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\NewFirmClientAccountRequestModel**](../Model/NewFirmClientAccountRequestModel.md)| Information about the account you wish to create. | [optional]
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel createFirmClientLinkage($x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageInputModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageInputModel | FirmClientLinkageInputModel
...
------------- | ------------- | ------------- | -------------
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageInputModel**](../Model/FirmClientLinkageInputModel.md)| FirmClientLinkageInputModel | [optional]
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteFirmClientLinkage($id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel getFirmClientLinkage($id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultFirmClientLinkageOutputModel listFirmClientLinkage($filter, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultFirmClientLinkageOutputModel**](../Model/FetchResultFirmClientLinkageOutputModel.md)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel rejectFirmClientLinkage($id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel resetFirmClientLinkage($id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FirmClientLinkageOutputModel revokeFirmClientLinkage($id, $x_avalara_client)
