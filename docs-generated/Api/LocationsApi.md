# Together\Taxes\Provider\AvaTax\Swagger\LocationsApi
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[] createLocationParameters($company_id, $location_id, $x_avalara_client, $body)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\LocationsApi(
...
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[] | The location parameters you wish to create.
 ...
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[]**](../Model/LocationParameterModel.md)| The location parameters you wish to create. | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel[]**](../Model/LocationParameterModel.md)
...
# **createLocations**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[] createLocations($company_id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[] | The location you wish to create.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[]**](../Model/LocationModel.md)| The location you wish to create. | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel[]**](../Model/LocationModel.md)
...
# **deleteLocation**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteLocation($company_id, $id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteLocationParameter($company_id, $location_id, $id, $x_avalara_client)
...
# **getLocation**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel getLocation($company_id, $id, $include, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel getLocationParameter($company_id, $location_id, $id, $x_avalara_client)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultLocationParameterModel listLocationParameters($company_id, $location_id, $filter, $top, $skip, $order_by, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultLocationParameterModel**](../Model/FetchResultLocationParameterModel.md)
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultLocationModel listLocationsByCompany($company_id, $filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultLocationModel**](../Model/FetchResultLocationModel.md)
...
# **queryLocations**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultLocationModel queryLocations($filter, $include, $top, $skip, $order_by, $x_avalara_client)
...
# **updateLocation**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel updateLocation($company_id, $id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel | The location you wish to update.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationModel**](../Model/LocationModel.md)| The location you wish to update. | [optional]
...
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel updateLocationParameter($company_id, $location_id, $id, $x_avalara_client, $body)
...
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel | The location parameter object you wish to update.
 ...
 **x_avalara_client** | **string**| Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) . | [optional] [default to Swagger UI; 20.9.0; Custom; 1.0]
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationParameterModel**](../Model/LocationParameterModel.md)| The location parameter object you wish to update. | [optional]
...
# **validateLocation**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\LocationValidationModel validateLocation($company_id, $id, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\LocationValidationModel**](../Model/LocationValidationModel.md)
