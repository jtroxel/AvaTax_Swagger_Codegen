# Together\Taxes\Provider\AvaTax\Swagger\DataSourcesApi
...
# **createDataSources**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel[] createDataSources($company_id, $x_avalara_client, $body)
...
$apiInstance = new Together\Taxes\Provider\AvaTax\Swagger\Api\DataSourcesApi(
...
$body = array(new \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel()); // \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel[] | 
 ...
 **body** | [**\Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel[]**](../Model/DataSourceModel.md)|  | [optional]

### Return type

[**\Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel[]**](../Model/DataSourceModel.md)
...
# **deleteDataSource**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\ErrorDetail[] deleteDataSource($company_id, $id, $x_avalara_client)
...
# **getDataSourceById**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel getDataSourceById($company_id, $id, $x_avalara_client)
...
# **listDataSources**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultDataSourceModel listDataSources($company_id, $filter, $top, $skip, $order_by, $x_avalara_client)
...
[**\Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultDataSourceModel**](../Model/FetchResultDataSourceModel.md)
...
# **queryDataSources**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\FetchResultDataSourceModel queryDataSources($filter, $top, $skip, $order_by, $x_avalara_client)
...
# **updateDataSource**
> \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel updateDataSource($company_id, $id, $x_avalara_client, $body)
...
$id = 56; // int | The id of the datasource you wish to delete.
$x_avalara_client = "Swagger UI; 20.9.0; Custom; 1.0"; // string | Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
$body = new \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel(); // \Together\Taxes\Provider\AvaTax\Swagger\Model\DataSourceModel | 
